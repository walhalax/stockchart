...
days = st.sidebar.slider('表示したい日数の期間を指定してください。', 1, 2000 ,90)
...
try:
    ...
    tickers = {
        'sp500': 'SPY',
        'nikkei225': 'JPN225',                      # ティッカーを用いて会社名の辞書リストを作成
        'google': 'GOOGL',
        'apple': 'AAPL',
        'meta': 'META',
        'amazon': 'AMZN',
    ...
    companies = st.multiselect(
        ...
        ['sp500', 'nikkei225', 'google', 'amazon', 'meta', 'apple', 'microsoft', 'tesla', 'nvidia', 'square', 'visa', 'cocacola', 'mcdonald', 'moderna', 'pfizer',]
    )
